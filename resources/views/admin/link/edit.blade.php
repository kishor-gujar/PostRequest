            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" action="{{route('link.edit', $link->id)}}">
                            {{ csrf_field() }}
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="receiver_type_id" id="receiver_type_id" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="receiver_sub_type_id" id="receiver_sub_type_id" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="request_line_id" id="request_line_id" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="number" value="{{ $link->number }}" class="form-control"
                                           placeholder="Enter price per month">
                                    <span class="text-danger">{{ $errors->first('number') }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="email">Link Email</label>
                                    <input type="email" name="email" value="{{ $link->email }}" class="form-control" placeholder="Enter price per month">
                                    <span class="text-danger">{{ $errors->first('email') }}</span>
                                </div>
                                <div class="form-group">
                                    <label for="number">Preferred Notification</label>
                                        <select name="preferred_notification" id="preferred_notification" class="form-control">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <input type="text" name="duration" value="{{ $link->duration }}" class="form-control float-right active" id="reservation">
