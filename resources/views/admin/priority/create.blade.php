            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post" action="{{route('priority.create')}}" novalidate>
                            {{ csrf_field() }}
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" value="{{ old('amount') }}" class="form-control " placeholder="Enter price">
